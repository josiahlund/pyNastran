...
def get_forces_moments_array(model, p0, load_case_id,
                             eid_map, nnodes, normals, dependents_nodes,
                             nid_map=None, include_grav=False):
    """
...
def get_pressure_array(model, load_case_id, eids, stop_on_failure=True):
    """
...
def get_temperatures_array(model, load_case_id, nid_map=None, dtype='float32'):
    """
...
def get_load_arrays(model, subcase_id, eid_map, node_ids, normals, nid_map=None):
    """
    ...
    for key in load_keys:
        try:
            ...
            continue
        try:
            load_case = model.get_reduced_loads(
            ...
            msg = 'LOAD=%s not found' % load_case_id
